(function(){
    ...
    var chart = raw.chart()
        .title('甘特图')
				.thumbnail("/static/raw/imgs/gantt.png")
				.description("甘特图（英语：Gantt chart）是条状图的一种流行类型，显示项目、进度以及其他与时间相关的系统进展的内在关系随着时间进展的情况，是由亨利 · 甘特于 1910 年开发出。在项目管理中，甘特图显示项目的终端元素的开始和结束，概要元素或终端元素的依赖关系。")
        .category('时间块')
        .model(sequence)
